  ...
  return (
    <>
      <div className="min-h-screen w-full p-4 md:p-7">
        ...
        <div
          id="tasklist"
          className="h-auto overflow-x-auto flex items-start justify-start gap-5 flex-nowrap w-full py-4 mt-16"
        >
          {/* Task Card 1 */}
          ...
          <div className="flex-shrink-0 w-[300px] p-5 bg-blue-400 rounded-xl">
            <div className="flex justify-between items-center">
              <h3 className="bg-red-600 text-sm px-3 py-1 rounded">All Task</h3>
          ...
          <div className="flex-shrink-0 w-[300px] p-5 bg-yellow-400 rounded-xl">
            <div className="flex justify-between items-center">
              <h3 className="bg-red-600 text-sm px-3 py-1 rounded">Backend</h3>
              <h4 className="text-sm">20/9/202</h4>
            </div>
            <h2 className="mt-5 text-2xl font-semibold">Backend Architecure</h2>
